...
using SAFE.DataStore.Factories;
...
#pragma warning disable SA1401 // Fields should be private
        protected readonly Dictionary<string, IDataTree> _dataTreeCache = new Dictionary<string, IDataTree>();
...
#pragma warning restore SA1401 // Fields should be private
        ...
        public static async Task<Result<IDatabase>> GetOrAddAsync(MdHead mdHead, IIndexer indexer)
        {
            var typeInfo = await TypeStoreFactory.GetOrAddTypeStoreAsync(mdHead.Md).ConfigureAwait(false);
